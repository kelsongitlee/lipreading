...
class RealtimeLipReader:
    def __init__(self, config_path, device="cuda:0", buffer_seconds=4, process_interval=1):
        ...
        """
        print("🚀 Initializing Real-time Lip Reader...")
        ...
        print("✅ Real-time Lip Reader initialized successfully!")
        print("\n🎮 Controls:")
            ...
            try:
                ...
                try:
                    ...
                    if result and result.strip():
                        self.current_result = f"📝 {result}"
                        print(f"\n🗣️  Lip Reading Result: {result}")
                    else:
                        self.current_result = "🔍 Processing... (no clear speech detected)"
                except Exception as e:
                    print(f"❌ Processing error: {e}")
                    self.current_result = f"❌ Error: {str(e)[:50]}..."
    ...
    def trigger_processing(self, force=False):
        ...
        try:
            ...
            print("⚠️  Processing queue full, skipping...")
    ...
    def run(self):
        ...
        print("\n🎬 Starting real-time lip reading...")
        print("📹 Webcam feed should appear. Press SPACE to start recording.")
        ...
        try:
            while self.is_running:
                ...
                if key == ord(' '):  # Space - toggle recording
                    ...
                    print("⚡ Force processing current buffer...")
